...
import com.connection.util.JsfUtil;
import com.connection.util.JsfUtil.PersistAction;
...
@ManagedBean(name = "order1Controller")
@SessionScoped
public class Order1Controller implements Serializable {

    @EJB
    private com.connection.Order1Facade ejbFacade;
